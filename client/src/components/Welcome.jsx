  ...
  return (
    <div className='flex w-full justify-center'>
      <div className='flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4'>
        <div className='flex flex-1 justify-start flex-col lg:flex-row'>
          ...
          <div className='flex flex-col flex-1 items-center justify-center w-full mf:mt-0 mt-10'>
            ...
            <div className='p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism'>
              ...
              { isLoading ? (
                ...
                <button type="button" onClick={handleSubmit} className='text-white w-full mt-2 border-[1px] p-2 border-[#3d47c] rounded-full cursor-pointer'> 
                  Send now
                </button>
              )}
            </div>
